...
let gapsCache = null;
let gapsPending = null;
async function loadAllGaps() {
    if (gapsCache) {
        return gapsCache;
    }
    if (!gapsPending) {
...
export async function showGaps() {
    ...
    `;
        ...
        const checkBtn = document.getElementById("checkGap");
        const nextBtn = document.getElementById("nextGapBtn");
